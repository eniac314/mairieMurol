...
Elm.Covoiturage.make = function (_elm) {
   ...
   _U.list([$Html$Attributes.$class("subContainerData noSubmenu"),$Html$Attributes.id("initCovoit")]),
   _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("Le covoiturage")]))
           ,A2($Html.p,
           _U.list([]),
   ...
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.id("container")]),
      _U.list([A3($Murol.renderMainMenu,address,_U.list(["Vie locale","Covoiturage"]),function (_) {    return _.mainMenu;}(model))
