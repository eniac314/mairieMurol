   ...
   var initialContent = {wrapper: initialWrapper
                        ...
                        _U.list([{ctor: "_Tuple3"
                                 ...
                                 ,_2: _U.list([A2($Html.img,
                                              ...
                                              _U.list([]))
                                              ,A2($Html.img,
                                              _U.list([$Html$Attributes.src("/images/bourgHiver.jpg"),$Html$Attributes.id("bourg4")]),
                                              _U.list([]))])}
                                ,{ctor: "_Tuple3"
                                 ,_0: "Le château"
                                ...
                                ,{ctor: "_Tuple3"
                                 ...
                                 ,_2: _U.list([A2($Html.p,_U.list([]),_U.list([$Html.text("Piétons, cyclistes soyez les bienvenus à Murol ! ")]))
                                              ...
                                              _U.list([A2($Html.img,
                                                      _U.list([$Html$Attributes.src("/images/voie1.jpg"),$Html$Attributes.id("voie1")]),
                                                      _U.list([]))
                                                      ,A2($Html.p,
                                                      _U.list([]),
                                              ...
                                              _U.list([A2($Html.img,
                                                      _U.list([$Html$Attributes.src("/images/voie2.jpg"),$Html$Attributes.id("voie2")]),
                                                      _U.list([]))
                                                      ,A2($Html.p,
                                                      _U.list([]),
                                ...
                                ,{ctor: "_Tuple3"
                                 ...
                                 ,_2: _U.list([A2($Html.img,_U.list([$Html$Attributes.src("/images/horizon3.jpg"),$Html$Attributes.id("hori3")]),_U.list([]))
                                              ,A2($Html.p,
                                              _U.list([]),
                                              ...
                                              _U.list([$Html.text("La magie des sites du moulin de Landrode \n                         et des grottes de Rajat a inspiré des \n                         artistes contemporains qui ont réalisés des œuvres majestueuses \n                         et éphémères dans la cadre de la manifestation \n                         annuelle « ")
                                                      ...
                                                      ,$Html.text("».")]))
                                              ,A2($Html.img,_U.list([$Html$Attributes.src("/images/rajat.jpg"),$Html$Attributes.id("rajatPic")]),_U.list([]))
                                              ,A2($Html.img,_U.list([$Html$Attributes.src("/images/hori2.jpg"),$Html$Attributes.id("hori2")]),_U.list([]))
                                              ,A2($Html.p,_U.list([$Html$Attributes.$class("toClear")]),_U.list([$Html.text(" ")]))])}
                                ,{ctor: "_Tuple3"
                                 ,_0: "Groire"
