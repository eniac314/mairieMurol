...
Elm.SportsDetente.make = function (_elm) {
   ...
   _U.list([A2($Html.h4,_U.list([]),_U.list([$Html.text("Activité : YOGA")]))
           ,A2($Html.p,
           _U.list([]),
           _U.list([$Html.text("Des séances de Yoga hebdomadaires sont mises en place dans l\'enceinte\n                     du centre Lignerat ou thermadore à St Nectaire tous les vendredis à 19h00.")]))
           ,A2($Html.p,_U.list([]),_U.list([$Html.text("Tarif : 10€ le cours d\'une heure et demie. ")]))
           ,A2($Html.p,_U.list([]),_U.list([$Html.text("renseignements sur place ou Association \"Créons Demain \"")]))
           ,A2($Html.p,_U.list([]),_U.list([$Html.text("Contact : ")]))
           ,A2($Html.p,_U.list([]),_U.list([$Html.text("Tél : 06 86 325 346 ")]))
           ,A2($Html.p,_U.list([]),_U.list([$Html.text("Mail  : isavey@wanadoo.fr")]))
           ,A2($Html.p,_U.list([]),_U.list([$Html.text("Professeur : Isabelle Chassaniol")]))
           ,A2($Html.h4,_U.list([]),_U.list([$Html.text("Rugby tennis de table")]))
           ,A2($Html.h4,_U.list([]),_U.list([$Html.text("Qi gong gymnastique")]))
           ,A2($Html.h4,_U.list([]),_U.list([$Html.text("Ski de fond et raquettes")]))
           ,A2($Html.h4,_U.list([]),_U.list([$Html.text("Tennis multisports")]))
           ,A2($Html.h4,_U.list([]),_U.list([$Html.text("terrain de pétanque")]))]));
