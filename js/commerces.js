...
Elm.Commerces.make = function (_elm) {
   ...
   var Commerce = F7(function (a,b,c,d,e,f,g) {    return {name: a,descr: b,addr: c,tel: d,fax: e,mail: f,site: g};});
   var defCom = A7(Commerce,"",_U.list([]),"","","","","");
   ...
   _U.list([$Html$Attributes.$class("subContainerData"),$Html$Attributes.id("commerces")]),
   _U.list([A2($Html.h5,_U.list([]),_U.list([$Html.text("Ouvert toute l\'année")]))
