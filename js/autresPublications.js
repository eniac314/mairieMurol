...
Elm.AutresPublications.make = function (_elm) {
   ...
   _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("Autres publications")]))
           ,A2($Murol.link,"Note de synthèse 2012 station classée de tourisme","")
           ,A2($Murol.link,"Présention du chateau de Murol par Dominique Allios","/baseDocumentaire/presentationAllios.pdf")
           ,A2($Murol.link,"Les volcans du Tartaret - Pierre Lavina","/baseDocumentaire/tartaretLavina.pdf")]));
