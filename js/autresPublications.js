...
Elm.AutresPublications.make = function (_elm) {
   ...
   _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("Autres publications")]))
           ,A2($Murol.link,"Note de synthèse 2012 station classée de tourisme","/baseDocumentaire/Notedesynthèse Murol 2012.pdf")
           ,A2($Murol.link,"Présention du chateau de Murol par Dominique Allios","/baseDocumentaire/decouvrirMurol/presentationAllios.pdf")
           ,A2($Murol.link,"Les volcans du Tartaret - Pierre Lavina","/baseDocumentaire/decouvrirMurol/tartaretLavina.pdf")]));
   ...
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.id("container")]),
      _U.list([A3($Murol.renderMainMenu,address,_U.list(["Documentation","Autres publications"]),function (_) {    return _.mainMenu;}(model))
