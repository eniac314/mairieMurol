...
Elm.PrintempsEte = Elm.PrintempsEte || {};
Elm.PrintempsEte.make = function (_elm) {
   "use strict";
   _elm.PrintempsEte = _elm.PrintempsEte || {};
   if (_elm.PrintempsEte.values) return _elm.PrintempsEte.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   $Utils = Elm.Utils.make(_elm);
   var _op = {};
   var _p0 = A3($Gallery.init,$Lightbox.picList(36),"printemps","Gallerie printemps été");
   var printempsEte = _p0._0;
   var printempsEteFx = _p0._1;
   var galleries = _U.list([{ctor: "_Tuple2",_0: printempsEte,_1: "printempsEte"}]);
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([$Html$Attributes.$class("subContainerData noSubmenu"),$Html$Attributes.id("printempsEte")]),
      A2($Basics._op["++"],
      _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("Paysages, printemps, été")]))]),
      A2($Basics._op["++"],
      galleriesHtml,
      _U.list([A2($Html.a,
   ...
   return _elm.PrintempsEte.values = {_op: _op
                                     ,Model: Model
                                     ...
                                     ,main: main
                                     ,galleries: galleries
                                     ,printempsEte: printempsEte
                                     ,printempsEteFx: printempsEteFx};
};
