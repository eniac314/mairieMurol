...
Elm.HorairesContact.make = function (_elm) {
   ...
   _U.list([$Html$Attributes.$class("subContainerData"),$Html$Attributes.id("horairesContact")]),
   _U.list([A2($Html.h4,_U.list([]),_U.list([$Html.text("Contacter la mairie")]))
           ...
           ,A2($Html.figure,_U.list([]),_U.list([A2($Html.img,_U.list([$Html$Attributes.src("/images/Mairie.jpg")]),_U.list([]))]))]));
