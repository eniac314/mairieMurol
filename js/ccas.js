...
Elm.CCAS.make = function (_elm) {
   ...
   _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("Centre Communal d\'Action Social")]))
           ...
           ,A2($Html.p,_U.list([]),_U.list([$Html.text("Membres non élus désignés par le maire parmi les Murolais:")]))
           ,A2($Html.p,_U.list([]),_U.list([$Html.text("Paulette Benatek, Floriane Chazet-Fillon, Olivier Dhainaut, Monique Picot et Suzanne Planeix")]))]));
