...
Elm.OffresEmploi.make = function (_elm) {
   ...
   _U.list([A2($Html.h4,_U.list([]),_U.list([$Html.text("Offres emploi de la mairie")]))
           ...
           ,A2($Html.p,
           _U.list([]),
           _U.list([$Html.text("Pôle emploi: "),A2($Html.a,_U.list([$Html$Attributes.href("www.pole-emploi.fr")]),_U.list([$Html.text("Lien")]))]))
           ,A2($Html.p,
           _U.list([]),
           _U.list([$Html.text("Relais Saisonniers Sancy: ")
                   ,A2($Html.a,_U.list([$Html$Attributes.href("www.lerelais-saisonniers-sancy.org/")]),_U.list([$Html.text("Lien")]))]))]));
