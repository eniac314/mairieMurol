...
Elm.Artistes.make = function (_elm) {
   ...
   _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("Artistes Murolais")]))
           ...
           _U.list([$Html.text("Pour les découvrir, suivez les liens en cliquant \n                     sur leurs noms. La plupart des liens conduit \n                     sur le site ")
                   ,A2($Html.a,
                   _U.list([$Html$Attributes.href("http://www.murol-terre-des-arts.wifeo.com"),$Html$Attributes.target("_blank")]),
           ...
           _U.list([A2($Html.h5,_U.list([]),_U.list([$Html.text("Marc HUMBERT : artisan d’Art, travaille le cuir")]))
                   ,A2($Html.img,_U.list([$Html$Attributes.src("/images/artistes/image7.jpg")]),_U.list([]))
                   ,A2($Html.a,
   ...
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.id("container")]),
      _U.list([A3($Murol.renderMainMenu,address,_U.list(["Culture et loisirs","Artistes"]),function (_) {    return _.mainMenu;}(model))
