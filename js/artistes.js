...
Elm.Artistes = Elm.Artistes || {};
Elm.Artistes.make = function (_elm) {
   "use strict";
   _elm.Artistes = _elm.Artistes || {};
   if (_elm.Artistes.values) return _elm.Artistes.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Dict = Elm.Dict.make(_elm),
   ...
   _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("Artistes Murolais")]))
           ...
           _U.list([$Html.text("Pour les découvrir, suivez les liens en cliquant \n                     sur leurs noms. La plupart des liens conduit \n                     sur le site ")
                   ,A2($Html.a,
                   _U.list([$Html$Attributes.href("http://murol-terre-des-arts.wifeo.com"),$Html$Attributes.target("_blank")]),
           ...
           _U.list([A2($Html.p,
                   _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "text-align",_1: "center"}]))]),
                   _U.list([$Html.text("Festival d’Art 2017 : dimanche 30 juillet ")]))
                   ,A2($Html.p,
                   _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "text-align",_1: "center"}]))]),
           ...
           _U.list([A2($Html.h5,_U.list([]),_U.list([$Html.text("Fabienne LAVEDRINE (atelier HOTANTIK BY FAB) : ferronnerie d’Art, sculpture")]))
                   ...
                   ,A2($Html.a,
                   _U.list([$Html$Attributes.target("_blank"),$Html$Attributes.href("https://www.facebook.com/HotantikByFabCrea/")]),
                   _U.list([$Html.text("page facebook")]))]))
           ,A2($Html.div,
           _U.list([$Html$Attributes.$class("artiste")]),
           _U.list([A2($Html.h5,_U.list([]),_U.list([$Html.text("Annie DUMONTEL : couture, création de costumes")]))
                   ,A2($Html.img,_U.list([$Html$Attributes.src("/images/artistes/image3.jpg")]),_U.list([]))
                   ,A2($Html.a,
                   _U.list([$Html$Attributes.target("_blank"),$Html$Attributes.href("/baseDocumentaire/L\'atelier couture.pdf")]),
                   _U.list([$Html.text("l’atelier couture")]))]))
           ,A2($Html.div,
           _U.list([$Html$Attributes.$class("artiste")]),
           _U.list([A2($Html.h5,_U.list([]),_U.list([$Html.text("Claire GOUTTEBEL : création de mini vitrines artisanales")]))
                   ,A2($Html.img,_U.list([$Html$Attributes.src("/images/artistes/Claire-Gouttebel.jpg")]),_U.list([]))
                   ,A2($Html.a,
           ...
           _U.list([A2($Html.h5,_U.list([]),_U.list([$Html.text("Alice JUAN : peinture")]))
                   ,A2($Html.img,_U.list([$Html$Attributes.src("/images/artistes/image8.jpg")]),_U.list([]))
                   ,A2($Html.a,
           ...
           _U.list([A2($Html.h5,_U.list([]),_U.list([$Html.text("Cathy MAURY : peinture, sculpture…")]))
                   ,A2($Html.img,_U.list([$Html$Attributes.src("/images/artistes/image9.jpg")]),_U.list([]))
                   ,A2($Html.a,
                   _U.list([$Html$Attributes.target("_blank"),$Html$Attributes.href("http://murol-terre-des-arts.wifeo.com/cathy-maury.php")]),
                   _U.list([$Html.text("site officiel")]))]))
           ,A2($Html.div,
           _U.list([$Html$Attributes.$class("artiste")]),
           _U.list([A2($Html.h5,_U.list([]),_U.list([$Html.text("Berny MEALLET : sculpture sur bois")]))
                   ,A2($Html.img,_U.list([$Html$Attributes.src("/images/artistes/image11.jpg")]),_U.list([]))
                   ,A2($Html.a,
           ...
           _U.list([A2($Html.h5,_U.list([]),_U.list([$Html.text("Gérard PEUCH :  poésie, peinture…")]))
                   ,A2($Html.img,_U.list([$Html$Attributes.src("/images/artistes/image12.jpg")]),_U.list([]))
                   ,A2($Html.a,
           ...
           _U.list([A2($Html.h5,_U.list([]),_U.list([$Html.text("Rudolf SCHÖN : violoniste, pianiste….")]))
                   ,A2($Html.img,_U.list([$Html$Attributes.src("/images/artistes/image13.jpg")]),_U.list([]))
                   ,A2($Html.a,
           ...
           _U.list([A2($Html.h5,_U.list([]),_U.list([$Html.text("Olivier SIMON : sculpture sur bois")]))
                   ,A2($Html.img,_U.list([$Html$Attributes.src("/images/artistes/image14.jpg")]),_U.list([]))
                   ,A2($Html.a,
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([A2($Utils.renderMainMenu,_U.list(["Culture et loisirs","Artistes"]),function (_) {    return _.mainMenu;}(model))
   ...
   return _elm.Artistes.values = {_op: _op
                                 ,subMenu: subMenu
