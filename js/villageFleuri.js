...
Elm.VillageFleuri.make = function (_elm) {
   ...
   _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("Le concours des villes et villages fleuris")]))
           ...
           _U.list([A2($Utils.link,"Compte rendu visite du jury en 2014","/baseDocumentaire/villageFleuri/compteRenduJury2014.pdf")
                   ,A2($Html.img,_U.list([$Html$Attributes.src("/images/Village fleuri.jpg")]),_U.list([]))
                   ,A2($Html.br,_U.list([]),_U.list([]))
                   ,A2($Utils.link," Téléchargez la fiche de présentation (PDF)","/baseDocumentaire/villageFleuri/presentationFR.pdf")]))
           ...
           ,A2($Utils.link,"Règlement (pdf)","/baseDocumentaire/villageFleuri/reglement.pdf")
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([A2($Utils.renderMainMenu,_U.list(["Documentation","Village fleuri"]),function (_) {    return _.mainMenu;}(model))
