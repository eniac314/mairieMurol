...
Elm.CMJ.make = function (_elm) {
   ...
   _U.list([$Html$Attributes.$class("subContainerData noSubmenu"),$Html$Attributes.id("cmj")]),
   _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("Conseil municipal des jeunes (CMJ)")]))
   ...
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.id("container")]),
      _U.list([A3($Murol.renderMainMenu,address,_U.list(["Mairie","CMJ"]),function (_) {    return _.mainMenu;}(model))
