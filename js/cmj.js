...
Elm.CMJ.make = function (_elm) {
   ...
   _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("Conseil municipal des jeunes (CMJ)")]))
           ...
           ,A2($Murol.link,"Demande de subvention","/baseDocumentaire/Associations/Demande%20de%20subvention.pdf")
           ,A2($Html.br,_U.list([]),_U.list([]))
           ,A2($Murol.link,"Fiche SACEM","/baseDocumentaire/Associations/fiche%20SACEM%20-%20mairie.pdf")
           ,A2($Html.br,_U.list([]),_U.list([]))
           ,A2($Murol.link,"SACEM","/baseDocumentaire/Associations/SACEM.pdf")
           ,A2($Html.br,_U.list([]),_U.list([]))]));
