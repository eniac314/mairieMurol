...
Elm.Patrimoine = Elm.Patrimoine || {};
Elm.Patrimoine.make = function (_elm) {
   "use strict";
   _elm.Patrimoine = _elm.Patrimoine || {};
   if (_elm.Patrimoine.values) return _elm.Patrimoine.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Dict = Elm.Dict.make(_elm),
   ...
   _U.list([A2($Html.p,
           ...
           ,A2($Utils.link,"Site officiel","http://www.musee-murol.fr/")
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([A2($Utils.renderMainMenu,_U.list(["Culture et loisirs","Patrimoine"]),function (_) {    return _.mainMenu;}(model))
   ...
   return _elm.Patrimoine.values = {_op: _op
