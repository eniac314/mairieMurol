...
Elm.Sortir.make = function (_elm) {
   ...
   var initialContent = {wrapper: function (content) {
                        ...
                        ,tiledMenu: $TiledMenu.initWithLink(_U.list([{ctor: "_Tuple4"
                                                                    ...
                                                                    ,{ctor: "_Tuple4"
                                                                     ...
                                                                     ,_1: ""
                                                                     ,_2: _U.list([])
                                                                     ,_3: "http://www.besse-superbesse.fr/fr/information/72830/cinemas"}]))};
   var update = F2(function (action,model) {
      var _p0 = action;
      if (_p0.ctor === "NoOp") {
            return model;
   ...
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.id("container")]),
      _U.list([A2($Murol.renderMainMenu$,_U.list(["Culture et loisirs","Sortir"]),function (_) {    return _.mainMenu;}(model))
              ,A2($Html.div,
              _U.list([$Html$Attributes.id("subContainer")]),
