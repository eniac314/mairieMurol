...
Elm.Medievales = Elm.Medievales || {};
Elm.Medievales.make = function (_elm) {
   "use strict";
   _elm.Medievales = _elm.Medievales || {};
   if (_elm.Medievales.values) return _elm.Medievales.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   $Utils = Elm.Utils.make(_elm);
   var _op = {};
   var _p0 = A3($Gallery.init,$Lightbox.picList(64),"medievales2017","Les Médiévales 2017");
   var medievales2017 = _p0._0;
   var medievales2017Fx = _p0._1;
   var _p1 = A3($Gallery.init,$Lightbox.picList(56),"medievales2016","Les Médiévales 2016");
   var medievales2016 = _p1._0;
   var medievales2016Fx = _p1._1;
   var _p2 = A3($Gallery.init,$Lightbox.picList(16),"medievales2015","Les Médiévales 2015");
   var medievales2015 = _p2._0;
   var medievales2015Fx = _p2._1;
   var _p3 = A3($Gallery.init,$Lightbox.picList(20),"medievales2014","Les Médiévales 2014");
   var medievales2014 = _p3._0;
   var medievales2014Fx = _p3._1;
   var _p4 = A3($Gallery.init,$Lightbox.picList(36),"medievales2013","Les Médiévales 2013");
   var medievales2013 = _p4._0;
   var medievales2013Fx = _p4._1;
   var galleries = _U.list([{ctor: "_Tuple2",_0: medievales2017,_1: "medievales2017"}
                           ,{ctor: "_Tuple2",_0: medievales2016,_1: "medievales2016"}
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([$Html$Attributes.$class("subContainerData noSubmenu"),$Html$Attributes.id("medievales")]),
      A2($Basics._op["++"],
      _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("Les Médiévales")]))]),
      A2($Basics._op["++"],
      galleriesHtml,
      _U.list([A2($Html.a,
   ...
   return _elm.Medievales.values = {_op: _op
                                   ,Model: Model
                                   ...
                                   ,medievales2013Fx: medievales2013Fx
                                   ...
                                   ,medievales2017Fx: medievales2017Fx};
};
