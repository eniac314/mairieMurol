...
Elm.Tourisme.make = function (_elm) {
   ...
   var maybeElem = F2(function (s,f) {    return $String.isEmpty(s) ? nullTag : f(s);});
   var dropT = F3(function (iD,s,v) {
      return _U.eq(function (_) {    return _.iD;}(v),iD) ? _U.update(v,{drop: $Basics.not(function (_) {    return _.drop;}(v))}) : v;
   });
   var Table = F4(function (a,b,c,d) {    return {name: a,entries: b,drop: c,iD: d};});
   var Meta = F2(function (a,b) {    return {address: a,tables: b};});
   ...
   var renderTable = F2(function (_p4,s) {
      var _p5 = _p4;
      var _p6 = A2($Dict.get,s,_p5.tables);
      if (_p6.ctor === "Nothing") {
            return nullTag;
         } else {
            var _p8 = _p6._0.drop;
            ...
            var makeRows = F2(function (b,xs) {
               ...
               if (_p7.ctor === "[]") {
                     ...
                     return A2($List._op["::"],A2(makeRow,_p7._0,b),A2(makeRows,$Basics.not(b),_p7._1));
                  }
            });
            var table$ = _p8 ? A2($Html.table,_U.list([$Html$Attributes.id(_p6._0.name)]),A2(makeRows,true,_p6._0.entries)) : nullTag;
            return A2($Html.div,
            _U.list([]),
            _U.list([A2($Html.h5,
                    _U.list([$Html$Attributes.$class("dropTable"),A2($Html$Events.onClick,_p5.address,$Murol.Drop(_p6._0.iD))]),
                    _U.list([$Html.text("Voir la liste")]))
                    ,A2($Html.span,_U.list([$Html$Attributes.$class("arrow")]),_U.list([arrow]))
                    ,table$]));
         }
   });
   var restaurants = function (meta) {
      return A2($Html.div,
      ...
      _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("Restaurants")]))
              ...
              ,A2($Html.h4,_U.list([]),_U.list([$Html.text("Restaurants")]))
              ,A2($Html.h5,_U.list([]),_U.list([$Html.text("A Beaune le Froid")]))
              ,A2(renderTable,meta,"restosBeaunes")
              ,A2($Html.h5,_U.list([]),_U.list([$Html.text("A Murol")]))
              ,A2(renderTable,meta,"restosMurol")
              ,A2($Html.h4,_U.list([]),_U.list([$Html.text("Bar - Brasserie")]))
              ,A2(renderTable,meta,"barBrasserie")
              ,A2($Html.h4,_U.list([]),_U.list([$Html.text("Bar de Nuit")]))
              ,A2(renderTable,meta,"barDeNuit")]));
   };
   var hebergements = function (meta) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("subContainerData"),$Html$Attributes.id("hebergTourisme")]),
      _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("Hebergements")]))
              ,A2($Html.h4,_U.list([]),_U.list([$Html.text("Hotels")]))
              ,A2($Html.p,
              _U.list([]),
              ...
              ,A2(renderTable,meta,"hotels")
              ,A2($Html.h4,_U.list([]),_U.list([$Html.text("Campings")]))
              ,A2($Html.p,
              _U.list([]),
              ...
              ,A2(renderTable,meta,"campings")
              ,A2($Html.h4,_U.list([]),_U.list([$Html.text("Chambres d\'Hôtes")]))
              ,A2($Html.p,
              _U.list([]),
              ...
              ,A2(renderTable,meta,"chambresHotes")
              ,A2($Html.h4,_U.list([]),_U.list([$Html.text("Meublés")]))
              ,A2($Html.p,
              _U.list([]),
              ...
              ,A2(renderTable,meta,"meubles")
              ,A2($Html.h4,_U.list([]),_U.list([$Html.text("Village Vacances")]))
              ,A2(renderTable,meta,"azureva")]));
   };
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.id("container")]),
      _U.list([A3($Murol.renderMainMenu,address,_U.list(["Tourisme"]),function (_) {    return _.mainMenu;}(model))
              ,A2($Html.div,
              _U.list([$Html$Attributes.id("subContainer")]),
              _U.list([A3($Murol.renderSubMenu,address,"Tourisme:",function (_) {    return _.subMenu;}(model))
                      ,A2(function (_) {    return _.mainContent;},model,A2(Meta,address,function (_) {    return _.tableMap;}(model)))]))
              ,$Murol.pageFooter]));
   });
   var tableMap = $Dict.fromList(_U.list([{ctor: "_Tuple2",_0: "restosBeaunes",_1: A4(Table,"restosBeaunes",restosBeaunes,false,0)}
                                         ,{ctor: "_Tuple2",_0: "restosMurol",_1: A4(Table,"restosMurol",restosMurol,false,1)}
                                         ,{ctor: "_Tuple2",_0: "barBrasserie",_1: A4(Table,"barBrasserie",barBrasserie,false,2)}
                                         ,{ctor: "_Tuple2",_0: "barDeNuit",_1: A4(Table,"barDeNuit",barDeNuit,false,3)}
                                         ,{ctor: "_Tuple2",_0: "hotels",_1: A4(Table,"hotels",hotels,false,4)}
                                         ,{ctor: "_Tuple2",_0: "campings",_1: A4(Table,"campings",campings,false,5)}
                                         ,{ctor: "_Tuple2",_0: "chambresHotes",_1: A4(Table,"chambresHotes",chambresHotes,false,6)}
                                         ,{ctor: "_Tuple2",_0: "meubles",_1: A4(Table,"meubles",meubles,false,7)}
                                         ,{ctor: "_Tuple2",_0: "azureva",_1: A4(Table,"azureva",azureva,false,8)}]));
   var initialContent = function (address) {
      return A2($Html.div,
   ...
   var changeMain = F2(function (model,s) {
      ...
      if (_p9.ctor === "Nothing") {
            ...
            return _U.update(model,{mainContent: _p9._0,subMenu: _U.update(sb,{current: s})});
         }
   });
   var update = F2(function (action,model) {
      var _p10 = action;
      ...
      {case "NoOp": return model;
         case "Entry": return A2(changeMain,model,_p10._0);
         case "Drop": return _U.update(model,{tableMap: A2($Dict.map,dropT(_p10._0),function (_) {    return _.tableMap;}(model))});
         default: return model;}
   });
   var subMenu = {current: "Accueil Tourisme"
                 ,entries: _U.list(["Accueil Tourisme","Découvrir Murol","Hebergements","Restaurants","Carte & plan","Animation estivale"])};
   var initialModel = {mainMenu: $Murol.mainMenu,subMenu: subMenu,mainContent: initialContent,tableMap: tableMap};
