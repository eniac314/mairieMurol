...
Elm.Artisanat.make = function (_elm) {
   ...
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.id("container")]),
      _U.list([A3($Murol.renderMainMenu,address,_U.list(["Vie économique","Artisanat"]),function (_) {    return _.mainMenu;}(model))
   ...
   _U.list([$Html$Attributes.$class("subContainerData noSubmenu"),$Html$Attributes.id("artisanat")]),
