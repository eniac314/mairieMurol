...
Elm.Artisanat = Elm.Artisanat || {};
Elm.Artisanat.make = function (_elm) {
   "use strict";
   _elm.Artisanat = _elm.Artisanat || {};
   if (_elm.Artisanat.values) return _elm.Artisanat.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Dict = Elm.Dict.make(_elm),
   ...
   var renderArtisan = function (_p2) {
      var _p3 = _p2;
   ...
   var renderArtisanMap = function (am) {
      var toRow = F3(function (k,v,acc) {
         return A2($List._op["::"],
         A2($Html.tr,_U.list([]),A2($Basics._op["++"],_U.list([A2($Html.th,_U.list([]),_U.list([$Html.text(k)]))]),A2($List.map,renderArtisan,v))),
         acc);
      });
   ...
   var Artisan = F7(function (a,b,c,d,e,f,g) {    return {name: a,descr: b,addr: c,tel: d,fax: e,mail: f,site: g};});
   var defArt = A7(Artisan,"",_U.list([]),"","","","","");
   ...
   var main = $StartApp$Simple.start({model: initialModel,view: view,update: update});
   return _elm.Artisanat.values = {_op: _op
                                  ,subMenu: subMenu
                                  ,initialModel: initialModel
                                  ,Artisan: Artisan
                                  ,view: view
                                  ,renderArtisanMap: renderArtisanMap
                                  ,renderArtisan: renderArtisan
                                  ,maybeElem: maybeElem
                                  ,nullTag: nullTag
