...
Elm.Publications.make = function (_elm) {
   ...
   _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("Divers")])),A2($Murol.link," Note de synthèse 2012 station classée de tourisme","")]));
   ...
   _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("Murol info")]))
           ...
           ,A2($Html.ul,
           _U.list([]),
           _U.list([A2($Html.li,_U.list([]),_U.list([A2($Murol.link,"Numero 28 - Janvier","baseDocumentaire/MUROL INFOS 28.doc")]))]))]));
