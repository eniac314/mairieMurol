...
Elm.Murol.make = function (_elm) {
   ...
   var renderMisc = function (misc) {
      var toLink = function (_p1) {
         var _p2 = _p1;
         return A2($Html.a,_U.list([$Html$Attributes.href(_p2._1)]),_U.list([A2($Html.li,_U.list([]),_U.list([$Html.text(_p2._0)]))]));
      };
   ...
   var renderNewsLetter = function (news) {
      var toNews = function (_p3) {
         var _p4 = _p3;
         return A2($Html.a,_U.list([$Html$Attributes.href(_p4._1)]),_U.list([A2($Html.li,_U.list([]),_U.list([$Html.text(_p4._0)]))]));
      };
   ...
   var renderNews = function (news) {
      var toNews = function (_p5) {
         var _p6 = _p5;
         return A2($Html.a,_U.list([$Html$Attributes.href(_p6._0)]),_U.list([A2($Html.li,_U.list([]),_U.list([$Html.text(_p6._1)]))]));
      };
      var newsList = A2($List.map,toNews,news);
      return A2($Html.div,
      _U.list([$Html$Attributes.id("news"),$Html$Attributes.$class("submenu entry")]),
      _U.list([A2($Html.h3,_U.list([]),_U.list([$Html.text("La mairie vous informe")])),A2($Html.ul,_U.list([]),newsList)]));
   };
   var renderListImg = function (pics) {
      ...
      A2($List.map,
      function (e) {
         return A2($Html.li,_U.list([]),_U.list([A2($Html.img,_U.list([$Html$Attributes.src(A2($Basics._op["++"],"/images/",e))]),_U.list([]))]));
      },
      pics))]));
   };
   ...
   var renderMainMenu = F2(function (adr,m) {
      ...
      if (_p7.ctor === "Leaf") {
            var _p9 = _p7._1;
            var _p8 = _p7._0;
            var link$ = $String.isEmpty(_p9) ? toUrl(_p8) : _p9;
            return A2($Html.a,_U.list([$Html$Attributes.href(link$)]),_U.list([$Html.text(_p8)]));
         } else {
            var _p11 = _p7._1;
            var _p10 = _p7._0;
            return $String.isEmpty(_p10) ? A2($Html.div,_U.list([$Html$Attributes.$class("mainMenu")]),A2($List.map,renderMainMenu(adr),_p11)) : A2($Html.div,
            _U.list([$Html$Attributes.$class(A2($Basics._op["++"],_p10,"Content"))]),
            _U.list([A2($Html.a,_U.list([$Html$Attributes.$class(A2($Basics._op["++"],_p10,"dropBtn"))]),_U.list([$Html.text(_p10)]))
                    ,A2($Html.div,_U.list([]),A2($List.map,renderMainMenu(adr),_p11))]));
         }
   });
   var view = F2(function (address,model) {
      ...
      _U.list([A2(renderMainMenu,address,function (_) {    return _.mainMenu;}(model))
              ,A2($Html.div,
              _U.list([$Html$Attributes.id("middleDiv")]),
              _U.list([renderNews(function (_) {    return _.news;}(model))
   ...
   var newsletters = _U.list([{ctor: "_Tuple2"
                             ...
                             ,{ctor: "_Tuple2"
                              ...
                              ,_1: "https://docs.google.com/forms/d/1sAJ3usxihhBxeY6SNyr2v3JI98Ii27QL-7N_Yjtw4v8/viewform"}]);
   var news = _U.list([{ctor: "_Tuple2"
                       ,_0: "http://www.lonelyplanet.fr/article/lauvergne-6eme-region-du-monde-visiter-en-2016"
                       ,_1: "L\'Auvergne fait une entrée remarquée dans le Best of du voyage de Lonely Planet en 2016. En 6ème position du classement des régions à visiter dans le monde."}]);
   ...
   var initialModel = {mainMenu: mainMenu,logos: logos,news: news,newsletters: newsletters,misc: misc};
   var main = $StartApp$Simple.start({model: initialModel,view: view,update: update});
   var Model = F5(function (a,b,c,d,e) {    return {mainMenu: a,logos: b,news: c,newsletters: d,misc: e};});
...
Elm.Publications.make = function (_elm) {
   ...
   _U.list([A2($Murol.link," Note de synthèse 2012 station classée de tourisme","")]));
   var resElec = A2($Html.div,
   _U.list([$Html$Attributes.$class("subContainerData"),$Html$Attributes.id("resElecPubli")]),
   _U.list([A2($Html.h4,_U.list([]),_U.list([$Html.text("Résultats 1er tour des élections municipales")]))
           ...
           ,A2($Html.h4,_U.list([]),_U.list([$Html.text("Résultats 2ème tour des élections municipales")]))
   ...
   _U.list([A2($Html.h4,_U.list([]),_U.list([$Html.text("Les élections municipales")]))
           ,A2($Html.p,
           _U.list([]),
   ...
   _U.list([A2($Html.h4,_U.list([]),_U.list([$Html.text("Reportages à Murol")]))
           ,A2($Murol.link,"JT du 19 septembre :","")
           ,$Html.text("Travail de l\'équipe archéologique sur le château \"juillet-août 2008\"")
           ,A2($Html.br,_U.list([]),_U.list([]))
           ,A2($Murol.link,"JT du 4 mai :","")
   ...
   _U.list([A2($Html.h5,_U.list([]),_U.list([$Html.text("2008")]))
           ,A2($Html.ul,
           _U.list([]),
           _U.list([A2($Html.li,_U.list([]),_U.list([A2($Murol.link,"Numero 01 - Avril","http://www.murol.fr/Murol_info/01.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Murol.link,"Numero 02 - Mai","http://www.murol.fr/Murol_info/02.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Murol.link,"Numero 03 - Juin","http://www.murol.fr/Murol_info/03.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Murol.link,"Numero 04 - Septembre","http://www.murol.fr/Murol_info/04.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Murol.link,"Numero 05 - Décembre","http://www.murol.fr/Murol_info/05.pdf")]))]))
           ,A2($Html.h5,_U.list([]),_U.list([$Html.text("2009")]))
           ,A2($Html.ul,
           _U.list([]),
           _U.list([A2($Html.li,_U.list([]),_U.list([A2($Murol.link,"Numero 05 - Février","http://www.murol.fr/Murol_info/06.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Murol.link,"Numero 07 - Mai","http://www.murol.fr/Murol_info/07.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Murol.link,"Numero 08 - Septembre","http://www.murol.fr/Murol_info/08.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Murol.link,"Numero 09 - Décembre","http://www.murol.fr/Murol_info/09.pdf")]))]))
           ,A2($Html.h5,_U.list([]),_U.list([$Html.text("2010")]))
           ,A2($Html.ul,
           _U.list([]),
           _U.list([A2($Html.li,_U.list([]),_U.list([A2($Murol.link,"Numero 10 - Août","http://www.murol.fr/Murol_info/10.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Murol.link,"Numero 11 - Octobre","http://www.murol.fr/Murol_info/11.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Murol.link,"Numero 12 - Décembre","http://www.murol.fr/Murol_info/12.pdf")]))]))
           ,A2($Html.h5,_U.list([]),_U.list([$Html.text("2011")]))
           ,A2($Html.ul,
           _U.list([]),
           _U.list([A2($Html.li,_U.list([]),_U.list([A2($Murol.link,"Numero 13 - Avril","http://www.murol.fr/Murol_info/13.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Murol.link,"Numero 14 - Mai","http://www.murol.fr/Murol_info/14.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Murol.link,"Numero 15 - Août","http://www.murol.fr/Murol_info/15.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Murol.link,"Numero 16 - Octobre","http://www.murol.fr/Murol_info/16.pdf")]))]))
           ,A2($Html.h5,_U.list([]),_U.list([$Html.text("2013")]))
           ,A2($Html.ul,
           _U.list([]),
           _U.list([A2($Html.li,_U.list([]),_U.list([A2($Murol.link,"Numero 17 - Juin","http://www.murol.fr/Murol_info/17.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Murol.link,"Numero 18 - Novembre","http://www.murol.fr/Murol_info/18.pdf")]))]))
           ,A2($Html.h5,_U.list([]),_U.list([$Html.text("2014")]))
           ,A2($Html.ul,
           _U.list([]),
           _U.list([A2($Html.li,_U.list([]),_U.list([A2($Murol.link,"Numero 19 - Avril","http://www.murol.fr/Murol_info/19.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Murol.link,"Numero 20 - Mai","http://www.murol.fr/Murol_info/20.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Murol.link,"Numero 21 - Juin","http://www.murol.fr/Murol_info/21.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Murol.link,"Numero 22 - Octobre","http://www.murol.fr/Murol_info/22.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Murol.link,"Numero 23 - Décembre","http://www.murol.fr/Murol_info/23.pdf")]))]))
           ,A2($Html.h5,_U.list([]),_U.list([$Html.text("2015")]))
           ,A2($Html.ul,
           _U.list([]),
           _U.list([A2($Html.li,_U.list([]),_U.list([A2($Murol.link,"Numero 24 - Mai","http://www.murol.fr/Murol_info/24.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Murol.link,"Numero 25 - Juin","http://www.murol.fr/Murol_info/25.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Murol.link,"Numero 26 - Septembre","http://www.murol.fr/Murol_info/26.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Murol.link,"Numero 27 - Novembre","http://www.murol.fr/Murol_info/27.pdf")]))]))]));
   ...
   var renderBulletin = function (_p0) {
      ...
      _U.list([A2($Html.figure,
              ...
              _U.list([A2($Html.img,_U.list([$Html$Attributes.src(A2($Basics._op["++"],"/images/bulletin/",_p1.cover))]),_U.list([]))
                      ,A2($Html.figcaption,_U.list([]),_U.list([$Html.text(_p1.date)]))]))
              ,A2($Html.ul,
              _U.list([]),
              A2($Basics._op["++"],
              A2($List._op["::"],
   ...
   var bulls = _U.list([A3(Bulletin,
                       ...
                       _U.list(["Equipe municipale"
                               ...
                               ,"Associations"
                               ,"Calendrier"]))]);
   var bulletin = A2($Html.div,_U.list([$Html$Attributes.$class("subContainerData"),$Html$Attributes.id("bullPubli")]),A2($List.map,renderBulletin,bulls));
   ...
   var changeMain = F2(function (model,s) {
      ...
      if (_p2.ctor === "Nothing") {
            ...
            return _U.update(model,{mainContent: _p2._0});
         }
   });
   var update = F2(function (action,model) {
      var _p3 = action;
      switch (_p3.ctor)
      {case "NoOp": return model;
         case "Entry": return A2(changeMain,model,_p3._0);
         default: return model;}
   });
   var subMenu = _U.list(["Délibération conseil municipal"
                         ,"Murol info"
                         ,"Bulletin municipal"
                         ,"Reportages à Murol"
                         ,"Elections"
