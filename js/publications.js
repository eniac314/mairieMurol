...
Elm.Publications.make = function (_elm) {
   ...
   var _op = {};
   var divers = A2($Html.div,
   _U.list([$Html$Attributes.$class("subContainerData"),$Html$Attributes.id("diversPubli")]),
   _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("Divers")])),A2($Utils.link," Note de synthèse 2012 station classée de tourisme","")]));
   var resElec = A2($Html.div,
   _U.list([$Html$Attributes.$class("subContainerData"),$Html$Attributes.id("resElecPubli")]),
   _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("Résultats des élections municipales")]))
           ,A2($Html.h4,_U.list([]),_U.list([$Html.text("Résultats 1er tour")]))
           ...
           ,A2($Html.h4,_U.list([]),_U.list([$Html.text("Résultats du 2ème tour")]))
   ...
   _U.list([$Html$Attributes.$class("subContainerData"),$Html$Attributes.id("elecPubli")]),
   _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("Les élections municipales")]))
           ,A2($Html.p,
           _U.list([]),
   ...
   var reportages = A2($Html.div,
   _U.list([$Html$Attributes.$class("subContainerData"),$Html$Attributes.id("repoPubli")]),
   _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("Reportages à Murol")]))
           ,A2($Utils.link,"JT du 19 septembre :","")
           ,$Html.text("Travail de l\'équipe archéologique sur le château \"juillet-août 2008\"")
           ,A2($Html.br,_U.list([]),_U.list([]))
           ,A2($Utils.link,"JT du 4 mai :","")
           ,$Html.text("Reportage sur les médiévales")
           ,A2($Html.br,_U.list([]),_U.list([]))]));
   var murolInf = A2($Html.div,
   _U.list([$Html$Attributes.$class("subContainerData"),$Html$Attributes.id("murolInfPubli")]),
   _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("Murol info")]))
           ,A2($Html.h5,_U.list([]),_U.list([$Html.text("2008")]))
           ,A2($Html.ul,
           _U.list([]),
           _U.list([A2($Html.li,_U.list([]),_U.list([A2($Utils.link,"Numero 01 - Avril","http://www.murol.fr/Murol_info/01.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Utils.link,"Numero 02 - Mai","http://www.murol.fr/Murol_info/02.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Utils.link,"Numero 03 - Juin","http://www.murol.fr/Murol_info/03.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Utils.link,"Numero 04 - Septembre","http://www.murol.fr/Murol_info/04.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Utils.link,"Numero 05 - Décembre","http://www.murol.fr/Murol_info/05.pdf")]))]))
           ,A2($Html.h5,_U.list([]),_U.list([$Html.text("2009")]))
           ,A2($Html.ul,
           _U.list([]),
           _U.list([A2($Html.li,_U.list([]),_U.list([A2($Utils.link,"Numero 05 - Février","http://www.murol.fr/Murol_info/06.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Utils.link,"Numero 07 - Mai","http://www.murol.fr/Murol_info/07.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Utils.link,"Numero 08 - Septembre","http://www.murol.fr/Murol_info/08.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Utils.link,"Numero 09 - Décembre","http://www.murol.fr/Murol_info/09.pdf")]))]))
           ,A2($Html.h5,_U.list([]),_U.list([$Html.text("2010")]))
           ,A2($Html.ul,
           _U.list([]),
           _U.list([A2($Html.li,_U.list([]),_U.list([A2($Utils.link,"Numero 10 - Août","http://www.murol.fr/Murol_info/10.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Utils.link,"Numero 11 - Octobre","http://www.murol.fr/Murol_info/11.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Utils.link,"Numero 12 - Décembre","http://www.murol.fr/Murol_info/12.pdf")]))]))
           ,A2($Html.h5,_U.list([]),_U.list([$Html.text("2011")]))
           ,A2($Html.ul,
           _U.list([]),
           _U.list([A2($Html.li,_U.list([]),_U.list([A2($Utils.link,"Numero 13 - Avril","http://www.murol.fr/Murol_info/13.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Utils.link,"Numero 14 - Mai","http://www.murol.fr/Murol_info/14.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Utils.link,"Numero 15 - Août","http://www.murol.fr/Murol_info/15.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Utils.link,"Numero 16 - Octobre","http://www.murol.fr/Murol_info/16.pdf")]))]))
           ,A2($Html.h5,_U.list([]),_U.list([$Html.text("2013")]))
           ,A2($Html.ul,
           _U.list([]),
           _U.list([A2($Html.li,_U.list([]),_U.list([A2($Utils.link,"Numero 17 - Juin","http://www.murol.fr/Murol_info/17.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Utils.link,"Numero 18 - Novembre","http://www.murol.fr/Murol_info/18.pdf")]))]))
           ,A2($Html.h5,_U.list([]),_U.list([$Html.text("2014")]))
           ,A2($Html.ul,
           _U.list([]),
           _U.list([A2($Html.li,_U.list([]),_U.list([A2($Utils.link,"Numero 19 - Avril","http://www.murol.fr/Murol_info/19.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Utils.link,"Numero 20 - Mai","http://www.murol.fr/Murol_info/20.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Utils.link,"Numero 21 - Juin","http://www.murol.fr/Murol_info/21.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Utils.link,"Numero 22 - Octobre","http://www.murol.fr/Murol_info/22.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Utils.link,"Numero 23 - Décembre","http://www.murol.fr/Murol_info/23.pdf")]))]))
           ,A2($Html.h5,_U.list([]),_U.list([$Html.text("2015")]))
           ,A2($Html.ul,
           _U.list([]),
           _U.list([A2($Html.li,_U.list([]),_U.list([A2($Utils.link,"Numero 24 - Mai","http://www.murol.fr/Murol_info/24.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Utils.link,"Numero 25 - Juin","http://www.murol.fr/Murol_info/25.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Utils.link,"Numero 26 - Septembre","http://www.murol.fr/Murol_info/26.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Utils.link,"Numero 27 - Novembre","http://www.murol.fr/Murol_info/27.pdf")]))]))
           ,A2($Html.h5,_U.list([]),_U.list([$Html.text("2016")]))
           ,A2($Html.ul,
           _U.list([]),
           _U.list([A2($Html.li,_U.list([]),_U.list([A2($Utils.link,"Numero 28 - Janvier","baseDocumentaire/MUROL INFOS 28.doc")]))]))]));
   var delib = A2($Html.div,
   _U.list([$Html$Attributes.$class("subContainerData"),$Html$Attributes.id("delibPubli")]),
   _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("Délibération conseil municipal")]))
           ,A2($Html.h5,_U.list([]),_U.list([$Html.text("2014")]))
           ,A2($Html.ul,
           _U.list([]),
           _U.list([A2($Html.li,_U.list([]),_U.list([A2($Utils.link,"19 mars","http://www.murol.fr/Deliberations_conseil/2014/19032014.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Utils.link,"4 avril","http://www.murol.fr/Deliberations_conseil/2014/04042014.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Utils.link,"10 avril","http://www.murol.fr/Deliberations_conseil/2014/10042014.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Utils.link,"16 juillet","http://www.murol.fr/Deliberations_conseil/2014/16072014.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Utils.link,"28 oct","http://www.murol.fr/Deliberations_conseil/2014/28102014.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Utils.link,"22 dec","http://www.murol.fr/Deliberations_conseil/2014/22122014.pdf")]))]))
           ,A2($Html.h5,_U.list([]),_U.list([$Html.text("2015")]))
           ,A2($Html.ul,
           _U.list([]),
           _U.list([A2($Html.li,_U.list([]),_U.list([A2($Utils.link,"12 février","http://www.murol.fr/Deliberations_conseil/2015/CM12022015.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Utils.link,"19 mars","http://www.murol.fr/Deliberations_conseil/2015/CM19032015.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Utils.link,"15 avril","http://www.murol.fr/Deliberations_conseil/2015/CM15042015.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Utils.link,"2 juin","http://www.murol.fr/Deliberations_conseil/2015/CM24092015.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Utils.link,"4 novembre","http://www.murol.fr/Deliberations_conseil/2015/CM04112015.pdf")]))]))]));
   var initialContent = delib;
   var renderBulletin = function (_p0) {
      var _p1 = _p0;
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("bulletin")]),
      _U.list([A2($Html.figure,
              _U.list([$Html$Attributes.$class("cover")]),
              _U.list([A2($Html.figcaption,_U.list([]),_U.list([$Html.text(_p1.date)]))
                      ,A2($Html.img,_U.list([$Html$Attributes.src(A2($Basics._op["++"],"/images/bulletin/",_p1.cover))]),_U.list([]))]))
              ,A2($Html.ul,
              _U.list([]),
              A2($Basics._op["++"],
              A2($List._op["::"],
              A2($Html.h6,_U.list([]),_U.list([$Html.text("Dans ce numéro:")])),
              A2($List.map,function (e) {    return A2($Html.li,_U.list([]),_U.list([$Html.text(e)]));},_p1.index)),
              _U.list([A2($Utils.link,"Téléchargez ici","")])))]));
   };
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.id("container")]),
      _U.list([A2($Utils.renderMainMenu,_U.list(["Mairie","Publications"]),function (_) {    return _.mainMenu;}(model))
              ,A2($Html.div,
              _U.list([$Html$Attributes.id("subContainer")]),
              _U.list([A3($Utils.renderSubMenu,address,"Publications:",function (_) {    return _.subMenu;}(model))
                      ,function (_) {
   ...
   _U.list([$Html$Attributes.$class("subContainerData"),$Html$Attributes.id("bullPubli")]),
   ...
   var contentMap = $Dict.fromList(_U.list([{ctor: "_Tuple2",_0: "Délibération conseil municipal",_1: delib}
                                           ...
                                           ,{ctor: "_Tuple2",_0: "Résultats élections municipales",_1: resElec}
   ...
   var changeMain = F2(function (model,s) {
      ...
      if (_p2.ctor === "Nothing") {
            ...
            return _U.update(model,{mainContent: _p2._0,subMenu: _U.update(sb,{current: s})});
         }
   });
   var update = F2(function (action,model) {    var _p3 = action;if (_p3.ctor === "NoOp") {    return model;} else {    return A2(changeMain,model,_p3._0);}});
   var subMenu = {current: "Délibération conseil municipal"
                 ,entries: _U.list(["Délibération conseil municipal"
                                   ,"Murol info"
                                   ,"Bulletin municipal"
                                   ,"Reportages à Murol"
                                   ,"Elections"
