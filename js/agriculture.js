...
Elm.Agriculture.make = function (_elm) {
   ...
   _U.list([$Html$Attributes.$class("subContainerData"),$Html$Attributes.id("agriculture")]),
   _U.list([A2($Html.p,_U.list([]),_U.list([$Html.text("Producteur fermier")]))
           ,A2($Murol.link,"Saint-Nectaire AOP","http://www.fromages-aop-auvergne.com/AOP-Saint-Nectaire")
           ,A2($Html.p,
           _U.list([]),
