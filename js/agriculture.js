...
Elm.Agriculture.make = function (_elm) {
   ...
   _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("Agriculture")]))
           ,A2($Html.p,_U.list([]),_U.list([$Html.text("Producteur fermier")]))
   ...
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.id("container")]),
      _U.list([A3($Murol.renderMainMenu,address,_U.list(["Vie économique","Agriculture"]),function (_) {    return _.mainMenu;}(model))
