...
Elm.G14Juillet = Elm.G14Juillet || {};
Elm.G14Juillet.make = function (_elm) {
   "use strict";
   _elm.G14Juillet = _elm.G14Juillet || {};
   if (_elm.G14Juillet.values) return _elm.G14Juillet.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   return _elm.G14Juillet.values = {_op: _op
                                   ,Model: Model
