...
Elm.VieScolaire.make = function (_elm) {
   ...
   _U.list([$Html$Attributes.$class("subContainerData")]),
   _U.list([A2($Html.p,_U.list([$Html$Attributes.$class("schoolAddress")]),_U.list([$Html.text("Collège du Pavin")]))
           ,A2($Html.p,_U.list([$Html$Attributes.$class("schoolAddress")]),_U.list([$Html.text("Rue des Prés de la ville")]))
           ,A2($Html.p,_U.list([$Html$Attributes.$class("schoolAddress")]),_U.list([$Html.text("63610 - Besse et Saint Anastaise")]))
           ,A2($Html.p,_U.list([$Html$Attributes.$class("schoolAddress")]),_U.list([$Html.text("Tél : 04 73 79 52 74")]))
           ,A2($Html.p,_U.list([$Html$Attributes.$class("schoolAddress")]),_U.list([$Html.text("Fax : 04 73 79 57 94")]))
   ...
   _U.list([$Html$Attributes.$class("subContainerData")]),
   _U.list([A2($Html.p,_U.list([$Html$Attributes.$class("schoolAddress")]),_U.list([$Html.text("Ecole élémentaire")]))
           ,A2($Html.p,_U.list([$Html$Attributes.$class("schoolAddress")]),_U.list([$Html.text("Rue de l\'hôtel de ville - 63790 Murol")]))
           ,A2($Html.p,_U.list([$Html$Attributes.$class("schoolAddress")]),_U.list([$Html.text("Tél : 04 73 88 62 91")]))
           ,A2($Html.h4,_U.list([]),_U.list([$Html.text("Inscription")]))
   ...
   _U.list([$Html$Attributes.$class("subContainerData")]),
   _U.list([A2($Html.p,_U.list([$Html$Attributes.$class("schoolAddress")]),_U.list([$Html.text("Ecole Maternelle")]))
           ,A2($Html.p,_U.list([$Html$Attributes.$class("schoolAddress")]),_U.list([$Html.text("Rue du Tartaret - 63790 Murol")]))
           ,A2($Html.p,_U.list([$Html$Attributes.$class("schoolAddress")]),_U.list([$Html.text("Tél : 04 73 88 64 70")]))
           ,A2($Html.p,
           _U.list([]),
