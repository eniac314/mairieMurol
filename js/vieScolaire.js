...
Elm.VieScolaire.make = function (_elm) {
   ...
   _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("Ecole élémentaire du Regroupement Pédagogique Intercommunal (RPI)")]))
           ,A2($Html.div,
           _U.list([$Html$Attributes.$class("schoolAddress")]),
           ...
           _U.list([$Html.text("*Des ")
                   ...
                   ,$Html.text("(TAP) sont organisés pour les enfants de 15h00 à 16h30 par le\n                   SIVOM de la vallée verte.")]))
           ,A2($Html.p,
           _U.list([]),
           ...
           _U.list([$Html.text("*Des ")
                   ,A2($Html.a,_U.list([$Html$Attributes.href("/PériEtExtra-scolaire.html?bloc=2")]),_U.list([$Html.text("Temps d’Activités Périscolaires")]))
                   ,$Html.text("(TAP) sont organisés pour les enfants de 15h15 à 16h45 par le\n                   SIVOM  de la vallée verte.")]))
           ,A2($Html.h4,_U.list([]),_U.list([$Html.text("Le projet d’écoles 2016/2020")]))
           ,A2($Html.p,
           _U.list([]),
           _U.list([$Html.text("Il est commun à l’école maternelle et aux écoles élémentaires\n                de Murol et Chambon sur Lac. Il se décline de la petite section\n                de maternelle au CM2.")]))
           ,A2($Html.p,
           _U.list([]),
           _U.list([$Html.text("Les priorités retenues dans ce projet sont l’amélioration \n                     de la compréhension (consignes, histoires, lecture, résolution de \n                     problèmes…) et du comportement (apprendre ensemble pour vivre \n                     ensemble, comprendre ce que signifie être un élève, \n                     respecter les autres et l’adulte…) \n                     ")]))
           ,A2($Html.h4,_U.list([]),_U.list([$Html.text("Inscription")]))
   ...
   _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("Ecole maternelle du SIVOM de la Vallée Verte")]))
           ,A2($Html.div,
           _U.list([$Html$Attributes.$class("schoolAddress")]),
           ...
           ,A2($Html.p,
           _U.list([]),
           _U.list([$Html.text("Pour inscrire votre enfant à la maternelle, prenez rendez-vous auprès de \n                     la directrice Séverine AUBOUIN au 04 73 88 \n                     64 70. ")]))
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([A2($Utils.renderMainMenu,_U.list(["Vie locale","Vie scolaire"]),function (_) {    return _.mainMenu;}(model))
              ,A2($Html.div,
              _U.list([$Html$Attributes.id("subContainer")]),
