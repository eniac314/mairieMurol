...
Elm.QuinzaineCom = Elm.QuinzaineCom || {};
Elm.QuinzaineCom.make = function (_elm) {
   "use strict";
   _elm.QuinzaineCom = _elm.QuinzaineCom || {};
   if (_elm.QuinzaineCom.values) return _elm.QuinzaineCom.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Dict = Elm.Dict.make(_elm),
   ...
   $StartApp$Simple = Elm.StartApp.Simple.make(_elm);
   var _op = {};
   var initialContent = A2($Html.div,_U.list([$Html$Attributes.$class("subContainerData"),$Html$Attributes.id("quinzaineCom")]),_U.list([]));
