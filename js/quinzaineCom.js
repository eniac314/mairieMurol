...
Elm.QuinzaineCom.make = function (_elm) {
   ...
   $StartApp$Simple = Elm.StartApp.Simple.make(_elm);
   var _op = {};
   var initialContent = A2($Html.div,_U.list([$Html$Attributes.$class("subContainerData noSubmenu"),$Html$Attributes.id("quinzaineCom")]),_U.list([]));
   ...
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.id("container")]),
      _U.list([A3($Murol.renderMainMenu,address,_U.list(["Vie économique","Quinzaine commerciale"]),function (_) {    return _.mainMenu;}(model))
