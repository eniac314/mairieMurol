...
Elm.Entreprises.make = function (_elm) {
   ...
   _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("Les entreprises")]))
           ,A2($Html.h4,_U.list([]),_U.list([$Html.text("Etudes et conseils")]))
   ...
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.id("container")]),
      _U.list([A3($Murol.renderMainMenu,address,_U.list(["Vie économique","Entreprises"]),function (_) {    return _.mainMenu;}(model))
