...
Elm.VosDemarches.make = function (_elm) {
   ...
   _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("Service civique")]))
           ...
           ,A2($Utils.link,"http://www.service-civique.gouv.fr","http://www.service-civique.gouv.fr")]));
   ...
   _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("inscription listes électorales")]))
           ...
           _U.list([A2($Html.li,
                   ...
                   _U.list([A2($Html.p,
                   _U.list([]),
                   _U.list([A2($Utils.link,"du formulaire qui vous concerne","/baseDocumentaire/electionsinscriptionf.pdf")]))]))]))
   ...
   _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("Etat-Civil")]))
           ...
           _U.list([$Html.text("Pour adresser votre demande par courrier postal, imprimez \n                     la demande en ")
                   ,A2($Utils.link,"cliquant ici","/baseDocumentaire/demande%20acte%20de%20naissance.pdf")
   ...
   _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("Véhicules")]))
           ...
           _U.list([A2($Html.li,
                   ...
                   _U.list([A2($Html.span,_U.list([]),_U.list([$Html.text("Certificat ")]))
                           ,A2($Utils.link,"d\'immatriculation","/baseDocumentaire/ddeimatcerfa10672.pdf")
                           ,A2($Html.span,_U.list([]),_U.list([$Html.text(" + ")]))
                           ,A2($Utils.link,"notice explicative","/baseDocumentaire/notexpcg50322C.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Utils.link,"Certificat de cession de véhicule","/baseDocumentaire/cessionvehic.pdf")]))
                   ,A2($Html.li,
                   _U.list([]),
                   _U.list([A2($Utils.link,"Certificat de non gage","http://www.interieur.gouv.fr/A-votre-service/Mes-demarches/Mes-teleservices")]))]))]));
   ...
   _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("Délivrance du permis")]))
           ...
           _U.list([A2($Html.li,
                   ...
                   ,A2($Html.li,
                   _U.list([]),
                   _U.list([A2($Utils.link,"Demande de délivrance","/baseDocumentaire/imprime_demande_permis_conduire.pdf")
                           ,A2($Html.span,_U.list([]),_U.list([$Html.text(" du permis de conduire")]))]))
                   ,A2($Html.li,
                   _U.list([]),
                   _U.list([A2($Utils.link,"Demande de permis international","/baseDocumentaire/imprime_demande_permis_international.pdf")]))]))]));
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([A2($Utils.renderMainMenu,_U.list(["Mairie","Vos démarches"]),function (_) {    return _.mainMenu;}(model))
              ,A2($Html.div,
              _U.list([$Html$Attributes.id("subContainer")]),
              _U.list([A3($Utils.renderSubMenu,address,"Vos démarches:",function (_) {    return _.subMenu;}(model))
                      ,function (_) {
