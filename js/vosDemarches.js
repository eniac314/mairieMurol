...
Elm.VosDemarches.make = function (_elm) {
   ...
   _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("inscription listes électorales")]))
           ...
           _U.list([A2($Html.li,
                   ...
                   _U.list([A2($Html.p,
                   _U.list([]),
                   _U.list([A2($Murol.link,"du formulaire qui vous concerne","/baseDocumentaire/electionsinscriptionf.pdf")]))]))]))
   ...
   _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("Etat-Civil")]))
           ...
           _U.list([$Html.text("Pour adresser votre demande par courrier postal, imprimez \n                     la demande en ")
                   ,A2($Murol.link,"cliquant ici","/baseDocumentaire/demande%20acte%20de%20naissance.pdf")
   ...
   _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("Véhicules")]))
           ...
           _U.list([A2($Html.li,
                   ...
                   _U.list([A2($Html.span,_U.list([]),_U.list([$Html.text("Certificat ")]))
                           ,A2($Murol.link,"d\'immatriculation","/baseDocumentaire/ddeimatcerfa10672.pdf")
                           ,A2($Html.span,_U.list([]),_U.list([$Html.text(" + ")]))
                           ,A2($Murol.link,"notice explicative","/baseDocumentaire/notexpcg50322C.pdf")]))
                   ,A2($Html.li,_U.list([]),_U.list([A2($Murol.link,"Certificat de cession de véhicule","/baseDocumentaire/cessionvehic.pdf")]))
                   ,A2($Html.li,
                   _U.list([]),
   ...
   _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("Délivrance du permis")]))
           ...
           _U.list([A2($Html.li,
                   ...
                   ,A2($Html.li,
                   _U.list([]),
                   _U.list([A2($Murol.link,"Demande de délivrance","/baseDocumentaire/imprime_demande_permis_conduire.pdf")
                           ,A2($Html.span,_U.list([]),_U.list([$Html.text(" du permis de conduire")]))]))
                   ,A2($Html.li,
                   _U.list([]),
                   _U.list([A2($Murol.link,"Demande de permis international","/baseDocumentaire/imprime_demande_permis_international.pdf")]))]))]));
