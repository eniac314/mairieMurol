...
Elm.SportEtDetentes = Elm.SportEtDetentes || {};
Elm.SportEtDetentes.make = function (_elm) {
   "use strict";
   _elm.SportEtDetentes = _elm.SportEtDetentes || {};
   if (_elm.SportEtDetentes.values) return _elm.SportEtDetentes.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Dict = Elm.Dict.make(_elm),
   ...
   $StartApp$Simple = Elm.StartApp.Simple.make(_elm);
   var _op = {};
   var initialContent = A2($Html.div,_U.list([$Html$Attributes.$class("subContainerData"),$Html$Attributes.id("sportEtDetentes")]),_U.list([]));
   ...
   var main = $StartApp$Simple.start({model: initialModel,view: view,update: update});
   return _elm.SportEtDetentes.values = {_op: _op
                                        ,subMenu: subMenu
                                        ,initialModel: initialModel
                                        ,view: view
