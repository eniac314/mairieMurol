...
Elm.Deliberations.make = function (_elm) {
   ...
   sortDate(_U.list([A2($Html.h5,_U.list([]),_U.list([$Html.text("2014")]))
                    ,A2($Html.ul,
                    _U.list([]),
                    _U.list([A2($Html.li,_U.list([]),_U.list([A2($Murol.link,"19 mars","/baseDocumentaire/Deliberations_conseil/2014/19032014.pdf")]))
                            ,A2($Html.li,_U.list([]),_U.list([A2($Murol.link,"4 avril","/baseDocumentaire/Deliberations_conseil/2014/04042014.pdf")]))
                            ,A2($Html.li,_U.list([]),_U.list([A2($Murol.link,"10 avril","/baseDocumentaire/Deliberations_conseil/2014/10042014.pdf")]))
                            ,A2($Html.li,_U.list([]),_U.list([A2($Murol.link,"16 juillet","/baseDocumentaire/Deliberations_conseil/2014/16072014.pdf")]))
                            ,A2($Html.li,_U.list([]),_U.list([A2($Murol.link,"28 oct","/baseDocumentaire/Deliberations_conseil/2014/28102014.pdf")]))
                            ,A2($Html.li,_U.list([]),_U.list([A2($Murol.link,"22 dec","/baseDocumentaire/Deliberations_conseil/2014/22122014.pdf")]))]))
                    ,A2($Html.h5,_U.list([]),_U.list([$Html.text("2015")]))
                    ,A2($Html.ul,
                    _U.list([]),
                    _U.list([A2($Html.li,_U.list([]),_U.list([A2($Murol.link,"12 février","/baseDocumentaire/Deliberations_conseil/2015/CM12022015.pdf")]))
                            ,A2($Html.li,_U.list([]),_U.list([A2($Murol.link,"19 mars","/baseDocumentaire/Deliberations_conseil/2015/CM19032015.pdf")]))
                            ,A2($Html.li,_U.list([]),_U.list([A2($Murol.link,"15 avril","/baseDocumentaire/Deliberations_conseil/2015/CM15042015.pdf")]))
                            ,A2($Html.li,_U.list([]),_U.list([A2($Murol.link,"2 juin","/baseDocumentaire/Deliberations_conseil/2015/CM24092015.pdf")]))
                            ,A2($Html.li,_U.list([]),_U.list([A2($Murol.link,"4 novembre","/baseDocumentaire/Deliberations_conseil/2015/CM04112015.pdf")]))
                            ,A2($Html.li,
                            _U.list([]),
                            _U.list([A2($Murol.link,"3 décembre","/baseDocumentaire/Deliberations_conseil/2015/03-12-2015.pdf")]))]))]))));
   var initialContent = delib;
   var update = F2(function (action,model) {    var _p2 = action;return model;});
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.id("container")]),
      _U.list([A3($Murol.renderMainMenu,address,_U.list(["Mairie","Délibérations"]),function (_) {    return _.mainMenu;}(model))
