...
Elm.GestionDesDechets.make = function (_elm) {
   ...
   _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("La gestion des déchets")]))
           ,A2($Utils.link,"Informations concernant la taxe d\'enlèvement des ordures ménagère","/baseDocumentaire/SICTOM/Informationsaugmentationtaxes.pdf")
           ,$Html.text("2014")
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([A2($Utils.renderMainMenu,_U.list(["Vie locale","Gestion des déchets"]),function (_) {    return _.mainMenu;}(model))
