...
Elm.OfficeTourisme.make = function (_elm) {
   ...
   _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("Office de Tourisme communautaire du massif du Sancy")]))
           ...
           _U.list([A2($Html.div,
                   ...
                   ,A2($Html.br,_U.list([]),_U.list([]))
                   ,A2($Murol.site,"www.sancy.com","http://www.sancy.com")
   ...
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.id("container")]),
      _U.list([A3($Murol.renderMainMenu,address,_U.list(["Tourisme","Office de Tourisme"]),function (_) {    return _.mainMenu;}(model))
