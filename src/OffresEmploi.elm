...
initialContent =
  div [ class "subContainerData", id "offresEmploi"]
      ...
      --, ul []
      --     [ li [] [text "adjoint technique territorial saisonnier"]
      --     , li [] [text "animateur/ animatrice stagiaire juillet"]
      --     , li [] [text "animateur/ animatrice stagiaire août"]
      --     ]
      --, p  []
      --     [ a [href "/baseDocumentaire/offresEmploi/offres sivom de la vallée verte  2016.pdf", target "_blank"]
      --         [text "détail des offres sivom de la vallée verte 2016"]
      --     ]
