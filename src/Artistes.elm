...
initialContent =
  div [ class "subContainerData noSubmenu", id "artistes"]
      ...
      --, p [] [a [href "baseDocumentaire/FA2017.pdf", target "_blank"] [text "Fiche d'inscription"]]
      , div []
            [ p [style [("text-align","center")]] [text "Festival d’Art 2017 : dimanche 30 juillet "]
      ...
      , div [ class "artiste"]
            ...
            , a   [target "_blank", href "https://www.facebook.com/HotantikByFabCrea/"]
                  [text "page facebook"] 
            ]
      , div [ class "artiste"]
