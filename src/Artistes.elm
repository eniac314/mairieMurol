...
initialContent =
  div [ class "subContainerData noSubmenu", id "artistes"]
      ...
      , p  [] [ text "Pour les découvrir, suivez les liens en cliquant 
                     ...
                     sur le site "
              , a [href "www.murol-terre-des-arts.wifeo.com", target "_blank"]
      ...
      , div [ class "artiste"]
            ...
            , img [src "/images/artistes/image3.jpeg"] []
            , img [src "/images/artistes/image4.jpeg"] []
            , a   [target "_blank", href ""]
                  [text "l’atelier couture"] 
            ]
      , div [ class "artiste"]
            [ h5  [] [text "Claire GOUTTEBEL : création de mini vitrines artisanales"]
            , img [src "/images/artistes/Claire-Gouttebel.jpeg"] []
      ...
      , div [ class "artiste"]
            ...
            , img [src "/images/artistes/image7.jpeg"] []
